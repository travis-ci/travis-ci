  ...
  class << self
    def default
      ...
      build :repository => minimal,
            ...
            :jobs => [
              { :log => Artifact::Log.new(:message => 'minimal log 1') }
            ]
      ...
      build :repository => minimal,
            ...
            :jobs => [
              { :log => Artifact::Log.new(:message => 'minimal log 2') }
            ]
      ...
      build :repository => minimal,
            ...
            :jobs => [
              { :log => Artifact::Log.new(:message => 'minimal log 3.1') },
              { :log => Artifact::Log.new(:message => 'minimal log 3.2') },
              { :log => Artifact::Log.new(:message => 'minimal log 3.3') },
              { :log => Artifact::Log.new(:message => 'minimal log 3.4') }
            ]
      ...
      build :repository => enginex,
            ...
            :jobs => [
              { :log => Artifact::Log.new(:message => 'enginex log 1') }
            ]
