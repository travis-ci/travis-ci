Travis.Controllers.Application = Backbone.Controller.extend({
  ...
  run: function() {
    ...
    this.jobsRails    = new Travis.Collections.Jobs();
    ...
    this.jobsRailsView    = new Travis.Views.Jobs.List();
  ...
  buildQueued: function(data) {
    var collection = data.repository.slug.match(/rails/) ? this.jobsRails : this.jobs;
