...
* A virtual server lent by "Avarteq":http://avarteq.de for running a "Resque":http://github.com/defunkt/resque worker.
...
* Ruby 1.8 is strongly recommended because "SystemTimer":http://rubygems.org/gems/SystemTimer doesn't work with Ruby 1.9
