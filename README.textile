...
* "Travis - a distributed build server tool for the Ruby community":http://svenfuchs.com/2011/2/5/travis-a-distributed-build-server-tool-for-the-ruby-community (introductional blog post about the original idea, Sven Fuchs)
...
!https://github.com/travis-ci/travis-ci/blob/master/docs/travis.architecture.png!
