 ...
 * "Nancy":https://travis-ci.org/NancyFx/Nancy in the .NET/Mono community
...
Please keep in mind that Travis CI evolves rapidly and this documentation may be outdated. Development, travis-ci.org maintenance and user documentation take priority.
