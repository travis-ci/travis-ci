 ...
 * Allows users to contribute build capacity by connecting a machine that runs "Travis workers":https://github.com/travis-ci/travis-worker and the "virtual machines they use":https://github.com/travis-ci/travis-boxes on their underused servers.
