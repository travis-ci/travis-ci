...
- travis-core: add $ thor travis:deploy and automatically add a git tag or update the production branch
- travis-core: add $ thor travis:config:sync to sync the current config with the keychain in heroku:config rake task
- travis-core: move the heroku rake task to thor
