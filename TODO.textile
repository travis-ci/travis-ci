...
- make sure we only load the log artifact when absolutely necessary

- optimize: https://gist.github.com/7fa474b1256bac72be8b

- wrap hub sql operations in a transaction
- have the hub respond to SIGTERM and shut down gracefully

- travis-worker: :stop command can not work when a build is running. need a different concept there.
