...
module TravisRails
  class Application < Rails::Application
    ...
    vendor  = %w(jquery-1.4.4.min.js jquery.timeago.js jquery.tipsy.js underscore handlebars backbone pusher-1.6.min.js unobtrusive_flash) # socky jquery-ui-1.8.9.highlight.min.js
